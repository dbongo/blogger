...
trait EmbeddedMongo extends BeforeAfterExample {
  ...
  def embedMongoDBVersion(): Version = Version.V2_7_1
  def inMemoryMongoDatabase(name: String = "default"): Map[String, String] = Map("mongodb.uri" -> "mongodb://127.0.0.1:12345/test")
